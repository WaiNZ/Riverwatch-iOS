...
@interface SimpleHTTPConnection (PrivateMethods)
- (void)processMessage;
...
- (void)processMessage
{
	...
	[delegate newRequestWithURL:(NSURL *)url method:(NSString *)method body:(NSData *)body headers:(NSDictionary *)headers connection:self];
...
- (BOOL)isMessageComplete
{
	...
	if(CFHTTPMessageIsHeaderComplete(message)) {
		...
		if(contentLengthHeader != NULL) {
			...
			int bodyLength = CFDataGetLength(messageBody);
